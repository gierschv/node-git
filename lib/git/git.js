...
Git.prototype.call_git = function(prefix, command, postfix, options, args, callback) {
  ...
  if (options['cwd']) delete options['cwd'];
  ...
  execute_git_call(call_string, { encoding: 'utf8', timeout: timeout, killSignal: 'SIGKILL', cwd: cwd }, callback);
}
